import { hoverStore } from "$lib/utils/hoverStore";
...
class Tooltip<T extends HTMLElement> {
	...
	private init() {
		...
		this.__container.style.setProperty("top", "8px");
		this.__container.style.setProperty("left", "50px");
		this.__container.style.setProperty("z-index", "100000");
		this.__container.style.setProperty("background-color", "#1971c2");
