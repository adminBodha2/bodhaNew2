<script lang="ts">
	...
	$metaTitle = 'Bodha Open Library | Essentials';
	$metaDescription = 'Essential Readings at Bodha Open Library.';
	$metaUrl = 'https://www.bodharesearch.in/library/essentials';
...
<Container narrow={true}>
	<div class="box-t column">
		<div class="column borderbot pbot32">
			<Crumb item1="BODHA OPEN LIBRARY" item1Link="/library" show2={true} item2="ESSENTIALS"/>
			<h2 class="source-serif tight">Essentials</h2>
