			...
			<div class="lab-side-inner">
				<nav class="lab-nav column rgap32">
					<div class="row cgap8 rgap8 pbot8" style="flex-wrap: wrap">
						<button class="ftnbtn" class:active={isCat[0]} on:click={() => {toggleCat(0); setCategory('aryanissue')}}>Aryan Issue</button>
						<button class="ftnbtn" class:active={isCat[1]} on:click={() => {toggleCat(1); setCategory('darshana')}}>Darshanas</button>
						<button class="ftnbtn" class:active={isCat[2]} on:click={() => {toggleCat(2); setCategory('essentials')}}>Essentials</button>
						<button class="ftnbtn" class:active={isCat[3]} on:click={() => {toggleCat(3); setCategory('iks')}}>IKS</button>
