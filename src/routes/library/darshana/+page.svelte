<script lang="ts">
	...
	let rootPath = page.url.pathname.split('/')[2];
	let books: any;

	$metaTitle = 'Bodha Open Library | Darshanas';
	$metaDescription = 'Readings on the Hindu Darshanas.';
...
<Container narrow={true}>
	<div class="box-t column">
		<div class="column borderbot pbot32">
			<Crumb item1="BODHA OPEN LIBRARY" item1Link="/library" show2={true} item2="DARSHANAS" />
			<h2 class="source-serif tight">Darshanas</h2>
