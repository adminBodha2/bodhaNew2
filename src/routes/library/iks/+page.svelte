<script lang="ts">
	...
	$metaTitle = 'Bodha Open Library | Indian Knowledge Systems';
	$metaDescription = 'Readings in IKS.';
	$metaUrl = 'https://www.bodharesearch.in/library/iks';
...
<Container narrow={true}>
	<div class="box-t column">
		<div class="column borderbot pbot32">
			<Crumb item1="BODHA OPEN LIBRARY" item1Link="/library" show2={true} item2="IKS"/>
			<h2 class="source-serif tight">Indian Knowledge Systems</h2>
