<script lang="ts">
	...
	$metaTitle = 'Bodha Open Library | Svayambodha';
...
<Container narrow={true}>
	<div class="box-t column">
		<div class="column borderbot pbot32">
			<Crumb item1="BODHA OPEN LIBRARY" item1Link="/library" show2={true} item2="Svayambodha"/>
			<h2 class="source-serif tight">Svayambodha</h2>
