<script lang="ts">
  ...
  let books:any
  $metaTitle = 'Bodha - Library | IKS'
  $metaDescription = 'Readings in Indian Knowledge Systems.'
  $metaUrl = 'https://www.bodharesearch.in/library/indian-knowledge-systems'
  $metaImage = '/images/bodhacover.png'

  onMount(() => {
    (async() => {
      books = await selectedOpenLibrary('iks');
    })();
  })
  ...
  <div class="box100 ytop column top-pad solo">
    <div class="row ycenter xbetween cgap16 borderbot pbot16">
      <div class="row ycenter cgap8">
        ...
        <small><b>INDIAN KNOWLEDGE SYSTEMS</b></small>
      </div>
