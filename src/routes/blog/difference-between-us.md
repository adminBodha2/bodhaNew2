...
When thinking of what is fundamentally different between a _Hindu_ worldview and _Western_ one, a few primary points come to mind. Here, by Western we refer in specific to the _Judeo-Christian_ worldview, which also includes the Islamic and is alternately called the _Abrahamic_ worldview.  
...
1) an intrinsic atemporality to the tradition, and  
2) the use of temporality as a narrative device in the corpus.  
