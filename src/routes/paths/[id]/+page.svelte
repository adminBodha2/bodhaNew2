<script lang="ts">
	...
	let shareUrl = $derived(encodeURIComponent(pageUrl));
...
<div class="stdbox padded bordertop">
	...
	<div class="row ycenter cgap8 rgap8 mwrap">
		<button class="nav-btn" onclick={() => setFilter('Concepts')} class:active={filterType === 'Concepts'}>Concepts</button>
		<button class="nav-btn" onclick={() => setFilter('Books')} class:active={filterType === 'Books'}>Books</button>
		<button class="nav-btn" onclick={() => setFilter('Articles')} class:active={filterType === 'Articles'}>Essays</button>
		<button class="nav-btn" onclick={() => setFilter('Thinkers')} class:active={filterType === 'Thinkers'}>Thinkers</button>
		<button class="nav-btn" onclick={() => setFilter('Schools')} class:active={filterType === 'Schools'}>Schools</button>
	</div>
