 			...
 			<div class="box glass-1">
				...
				<div class="area-body p16">
					...
					<div class="area-links box">
						...
						{#if item.href}
							<a class="paragraph-text area-link p16 blank row xbetween width100" href={item.href}>
								{item.label}
							</a>
						{:else}
